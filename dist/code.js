                    ...
                    if (device.type === "INSTANCE" && device.visible === true) {
                        ...
                        if (device.mainComponent.parent.name === 'universal') {
                            ...
                            config[zoneName + '_' + zoneCount].items[deviceName + '_' + deviceCount]['custom_data'] = {
                                ...
                                'device_type_id': (_a = device.mainComponent) === null || _a === void 0 ? void 0 : _a.id,
                                'device_type_en': device.variantProperties['Device type (en)'],
                                'device_type_ru': device.variantProperties['Device type (ru)'],
                                'top': (device.y / frameHeight) * 100,
                                'left': (device.x / frameWidth) * 100,
                                'placement': 'auto',
                                'icon_path': (_c = (_b = device.children[0].mainComponent) === null || _b === void 0 ? void 0 : _b.children[0]) === null || _c === void 0 ? void 0 : _c.fillGeometry
                            };
